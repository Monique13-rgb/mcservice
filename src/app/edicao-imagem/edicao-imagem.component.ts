...
@Component({
    ...
    styleUrls: ['./edicao-imagem.component.scss']
})
export class EdicaoImagemComponent implements OnInit, OnDestroy {

    @Input() imagem: Imagem;
    @Input() idCelulares: string;
    ...
    ngOnInit(): void {
        ...
        if (this.imagem.url) {
            ...
            const nome = `${this.idCelulares}_${new Date().getTime()}_${this.imagem.arquivo.name}`;
